...
#  3rd May 2013
#  to include a hard coded selection of level
#  setdim 3 $fieldlist 1   
#  line selects the level alter 1 to be the level of choice
#
#  And select only variables 4 and 5 that is u and v
#
#
...
# select only the 850hpa level
#setdim 3 $fieldlist 1   

setdim 4 $filedlist 360-540
