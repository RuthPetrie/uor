...
/* initialize track_id's */
                  ...
                  fprintf(fobjo, "%f %f %e %f %f %f %e\n", (fp->x).xy, (fp->y).xy, fp->str, fp->r_sh, fp->ornt[0], fp->ornt[1], fp->area);
...
/* initialize track_id's */
                  ...
                  if(tf == 3) fprintf(fobjo, "%d %d %e\n", (fp->x).ixy, (fp->y).ixy, fp->str);

                  else fprintf(fobjo, "%f %f %e\n", (fp->x).xy, (fp->y).xy, fp->str);
