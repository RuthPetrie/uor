...

{
     ...
     scanf("\n");
     if((ipj = getchar()) == 'y') proj = proj_group(-1, -1);
               ...
               if(ipj == 'y'){
                 ...
                 switch(pgr){
                    case 0:
                       switch(gr->prgr){
                          case 0:
                            proj_point(proj, &xa, &ya,  pgr, tpr, gr->prgr, gr->prty);
                            tid[count] = ta;
                            xf[count] = xa;
                            yf[count] = ya;
                            zf[count] = za;
                            ...
                            break;
                          case 1:
                            if(proj_point(proj, &xa, &ya, pgr, tpr, gr->prgr, gr->prty, &gr1->alat, &gr1->alng)){
                              ...
                              if(pl_vec){
                                xor[c1] = atr->or_vec[0];
                                yor[c1] = atr->or_vec[1];
                                vect_proj(atr->xf, atr->yf, xor+c1, yor+c1, proj, 0, 0, 0);
                              }

                              ++c1;
                            }
                            else if(gr2){
                              proj_point(proj, &xa, &ya, pgr, tpr, gr->prgr, gr->prty, &gr2->alat, &gr2->alng);
                              tid[tot_fet-c2] = ta;
                              xf[tot_fet-c2] = xa;
                              yf[tot_fet-c2] = ya;
                              zf[tot_fet-c2] = za;
                              if(pl_vec){
                                ...
                                vect_proj(atr->xf, atr->yf, xor+tot_fet-c2, yor+tot_fet-c2, proj, 0, 0, 1);
                              }
                              ++c2;
                            }
                            break;
                    ...
                    case 1:
                       ...
                       switch(gr->prgr){
                          case 0:
                            ...
                            proj_point(proj, &xa, &ya, pgr, tpr, gr->prgr, gr->prty, &alat, &alng);
                            tid[count] = ta;
                            xf[count] = xa;
                            yf[count] = ya;
                            zf[count] = za;
                          ...
                          case 1:
                            xt = xa;
                            yt = ya;
                            if(proj_point(proj, &xt, &yt, pgr, tpr, gr->prgr, gr->prty, &alat, &alng, &gr1->alat, &gr1->alng)){
                              tid[c1] = ta;
                              xf[c1] = xt;
                              yf[c1] = yt;
                              zf[c1] = za;
                              ...
                              proj_point(proj, &xa, &ya, pgr, tpr, gr->prgr, gr->prty, &alat, &alng, &gr2->alat, &gr2->alng);
                              tid[tot_fet-c2] = ta;
                              xf[tot_fet-c2] = xa;
                              yf[tot_fet-c2] = ya;
                              zf[tot_fet-c2] = za;
