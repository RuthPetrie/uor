...
void azimuthal_grid_assign(GRID * , CNTRY * , float , float , int , int , int , int , int );
...
/* find region extent in projected space */
      ...
      azimuthal_grid_assign(gr1, cm1, gr1->alat, gr1->alng, gr1->ox1u, gr1->ox2u, gr1->oy1u, gr1->oy2u, prty);
      ...
      if(wh == 'b'){
         ...
         azimuthal_grid_assign(gr2, cm2, gr2->alat, gr2->alng, gr2->ox1u, gr2->ox2u, gr2->oy1u, gr2->oy2u, prty);
...
void azimuthal_grid_assign(GRID *ggr, CNTRY *cmm, float alat, float alng, int xng1, int xng2, int ylt1, int ylt2, int prty)
