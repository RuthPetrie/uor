...
% LOAD DATA
%-------------------------------------------------------------------
b = load_netcdf_struct('/export/carrot/raid2/wx019276/DATA/MODEL/MODELOUT/balance_001.nc');
%m = load_nc_struct('/export/carrot/raid2/wx019276/DATA/MODEL/MODELOUT/convection1.nc');
n = load_netcdf_struct('/export/carrot/raid2/wx019276/DATA/MODEL/MODELOUT/convection2.nc'); 
%'/export/carrot/raid2/wx019276/DATA/MODEL/MODELOUT/convection1.nc'
%wmax = max(max(max(abs(m.w(:,:,:)))))
%waxis = [-wmax wmax]
m = load_netcdf_struct('/export/carrot/raid2/wx019276/DATA/MODEL/MODELOUT/coriolis_11.nc');
