...
% load file
m = load_nc_struct('/home/wx019276/PHD/ModelOutput.nc')
...
%    colorbarf(coutg, sg), title('Geostrophic imbalance')   
 ...
 if make_anim == 1
     if t < 10
       filename = sprintf('/export/carrot/raid2/wx019276/FIGURES/OCT_2013/anim-00%d',t);
       elseif t >= 100
         filename = sprintf('/export/carrot/raid2/wx019276/FIGURES/OCT_2013/anim-%d',t);
       else
       filename = sprintf('/export/carrot/raid2/wx019276/FIGURES/OCT_2013/anim-0%d',t);
     end    
