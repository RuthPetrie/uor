...
%ylabel('u', 'Rotation', 0),
title('Input data','FontSize',14)
%xlabel(['Longitudinal distance',10,'(km)'],'FontSize',12), 
...
ylabel(['Height      ',10,'(m)   '],'FontSize',14, 'Rotation',0 )
%-------------------------------------------------------------
subplot(5,3,7), pcolor(xax,yax(2:60),w_o(2:60, 2:361)), 
...
ylabel(['Height       ',10,'(m)   '],'FontSize',14, 'Rotation',0 )
%-------------------------------------------------------------
subplot(5,3,13), pcolor(xax,yax(2:60),bp_o(2:60, 2:361)), 
...
%-------------------------------------------------------------
subplot(5,3,8), pcolor(xax,yax(2:60),w_t(2:60, 2:361)), 
...
%-------------------------------------------------------------
subplot(5,3,14), pcolor(xax,yax(2:60),bp_t(2:60,2:361)), 
...
u_e_max = max(max(abs(u_err(:,:))));
u_e_axis = [-u_e_max u_e_max];
v_e_max = max(max(abs(v_err(:,:))));
v_e_axis = [-v_e_max v_e_max];
w_e_max = max(max(abs(w_err(:,:))));
w_e_axis = [-w_e_max w_e_max];
rp_e_max = max(max(abs(r_err(:,:))));
rp_e_axis = [-rp_e_max rp_e_max];
bp_e_max = max(max(abs(b_err(:,:))));
...
%-------------------------------------------------------------
subplot(5,3,15), pcolor(xax,yax(2:60),b_err), 
