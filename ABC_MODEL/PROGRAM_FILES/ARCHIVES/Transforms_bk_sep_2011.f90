...
!===================================================================================================
 ...
 DO k = 1, nlongs
  ...
  ELSE
     ctrl_state_in % u(1:nlevs,k) = imag * 2.0 * (REAL(ktemp)) * pi * ctrl_state_in % u(1:nlevs,k) / domain  
   ENDIF
 ENDDO
...
IMPLICIT NONE
 ...
 DO k = 1, nlongs
  ...
  ELSE
     ctrl_state_in_hat % u(1:nlevs,k) = negimag * 2.0 * (REAL(ktemp)) * pi * ctrl_state_in_hat % u(1:nlevs,k) / domain  
   END IF
 END DO
...
!     END DO
!     OUTPUT OF ABOVE SHOWS THAT EIGENVECTORS ARE COLUMNS (:,e)
