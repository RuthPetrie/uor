...
! ------------------------------
  ...
  model_ics_data_out_file  = 'Processed_Initial_Data_a2.nc'
  latitude                 = 144
...
! ------------------------------
  ...
  model_ics_data_read_file = 'Processed_Initial_Data_a2.nc'
  model_output_file        = 'expt_a2.nc'
  diagnostics_file         = 'expt_a2.dat'
  dt                       = 0.1
  runlength                = 21600.0
  ndumps                   = 36
