...
! ------------------------------
  ...
  model_ics_data_out_file  = 'Processed_Initial_Data_a1.nc'
  latitude                 = 144
...
! ------------------------------
  ...
  model_ics_data_read_file = 'Processed_Initial_Data_a1.nc'
  model_output_file        = 'expt_a1.nc'
  diagnostics_file         = 'expt_a1.dat'
  dt                       = 0.1
  runlength                = 21600.0
  ndumps                   = 36
