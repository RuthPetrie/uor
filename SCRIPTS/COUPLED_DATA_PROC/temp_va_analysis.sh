...
#  idl -e "plot_tempva_resp_seasonally" -args ${CDDIR}${VARDIR} ${PDDIR}${VARDIR} ${FIGOUTDIR} ${VARNAME}  
  idl -e "plot_tempva_resp_ns_seas" -args ${CDDIR}${VARDIR} ${PDDIR}${VARDIR} ${FIGOUTDIR} ${VARNAME}  
  idl -e "plot_tempva_resp_bimonthly" -args ${CDDIR}${VARDIR} ${PDDIR}${VARDIR} ${FIGOUTDIR} ${VARNAME}
