...
extract_monthly_data () {
  ...
  for ENS in {1..30}; do
    ...
    for MON in ${MONTHS}; do
      cdo selname,${UM1} *.pm*${MON}.nc ${MEDIR}${UM1}_${ENS}_${MON}.nc
      cdo selname,${UM2} *.pm*${MON}.nc ${MEDIR}${UM2}_${ENS}_${MON}.nc
      cdo mul ${MEDIR}${UM1}_${ENS}_${MON}.nc ${MEDIR}${UM2}_${ENS}_${MON}.nc ${MEDIR}${VARNAME}_${ENS}_${MON}.nc
      rm -f ${MEDIR}${UM1}_${ENS}_${MON}.nc ${MEDIR}${UM2}_${ENS}_${MON}.nc
    done   
  done
