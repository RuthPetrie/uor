...
#  for ENS in {1..30}; do 
#     cdo mergetime ${VARNAME}_${ENS}_apr.nc ${VARNAME}_${ENS}_may.nc ${VARNAME}_${ENS}_ens_MAM.nc 
...
####################################################################################################
###########################################################################
calculate_raw_monthly_zonal_means () {
  ...
  MDDIR=${DDIR}${VARDIR}MONTHLY/
  MEDDIR=${DDIR}${VARDIR}MONTHLY/ENSB
  ...
  for ENS in {1..30}; do
    for MON in ${MONTHS}; do
      cdo zonmean ${VARNAME}_${ENS}_${MON}.nc ${VARNAME}_zonm_${ENS}_${MON}.nc
    done
  done
...
calculate_monthly_area_aves () {
  ...
  for ENS in {1..30}; do
    for MON in ${MONTHS}; do
      cdo sellonlatbox,90,125,20,35 ${VARNAME}_${ENS}_${MON}.nc ${VARNAME}_eawmne_${ENS}_${MON}.nc
#      cdo sellonlatbox,75,125,5,30 ${VARNAME}_${ENS}_${MON}.nc ${VARNAME}_eawm_${ENS}_${MON}.nc
#      cdo sellonlatbox,75,90,5,30 ${VARNAME}_${ENS}_${MON}.nc ${VARNAME}_eawmw_${ENS}_${MON}.nc
#      cdo sellonlatbox,90,125,5,30 ${VARNAME}_${ENS}_${MON}.nc ${VARNAME}_eawme_${ENS}_${MON}.nc
       cdo fldmean ${VARNAME}_eawmne_${ENS}_${MON}.nc ${VARNAME}_eawmne_areaave_${ENS}_${MON}.nc
#       cdo fldmean ${VARNAME}_eawm_${ENS}_${MON}.nc ${VARNAME}_eawm_areaave_${ENS}_${MON}.nc
#       cdo fldmean ${VARNAME}_eawmw_${ENS}_${MON}.nc ${VARNAME}_eawmw_areaave_${ENS}_${MON}.nc
 #      cdo fldmean ${VARNAME}_eawme_${ENS}_${MON}.nc ${VARNAME}_eawme_areaave_${ENS}_${MON}.nc
    done
  done
