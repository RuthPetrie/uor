PRO PLT_NHPS_BIMONTHLY_VECT, OFILE=ofile, CTRLEXPTX=ctrlx, CTRLEXPTY=ctrly, $
...
FOR x=1,nt DO BEGIN
  ...
  IF x EQ 1 THEN BEGIN
    CON, F=ctrlmag(*,*,s), X=longs, Y=lats, /NOLINES, /NOAXES, $
         /NOCOLBAR, LEFT_LABEL='Surface!c!cwind!c!cstress',TITLE = mons(s)
