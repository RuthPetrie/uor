...
;(C) NCAS 2010
;
; MODIFIED R. PETRIE 5-11-2013
; CHANGED size so that it not only scales the symbols but also line thickness
; 
; com='GPLOT, X=xpts, Y=ypts, COL=linecol, /DEVICE'
; becomes
; com='GPLOT, X=xpts, Y=ypts, COL=linecol, THICK=size, /DEVICE'
