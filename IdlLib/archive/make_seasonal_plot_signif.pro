FUNCTION MAKE_SEASONAL_PLOT_SIGNIF, variable, latitudes, longitudes, filename, projection, $
                             colourscale, latminimum, view, colbartitle, fig_title, signif, alpha
...
PSOPEN, XPLOTS=2 ,YPLOTS=2, XOFFSET= 1000,  YSPACING = 1500, XSPACING = 1500, MARGIN=2500,  $  
 ...
 ;     COLBAR, COORDS=[6850,1200,22850,1500], TITLE=colbartitle; /ALT
      ...
      PFILL, F= signif(*,*,t), X = longitudes, Y = latitudes, $
             MIN = 0.0, MAX = alpha, SIZE = 125
